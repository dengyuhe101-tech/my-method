...
enum layer_type_enum{CONV, POOL, DENSE, NORM, LRN, CHGATE};
...
enum IoU_types_enum{IOU, GIOU, DIOU, DIOU2, ROTIOU};
...
typedef struct chgate_param chgate_param;
...
struct yolo_param
{
	...
	int fit_angle;
		...
		int obb_loss_mode;
		int multi_pos_topk;
		int prob_quality_mode;
		int obj_quality_mode;
		float prob_quality_scale;
		float prob_quality_floor;
		float obj_quality_scale;
		float obj_quality_floor;
		float obj_quality_center_weight;
		float obj_quality_geom_weight;
		float obj_quality_phys_weight;
		float obj_quality_da_center_weight;
		float obj_quality_da_geom_weight;
		float obj_quality_da_phys_weight;
		float obj_quality_da_flux_max;
		float obj_quality_da_aspect_min;
		float obj_quality_da_aspect_max;
		float obj_quality_da_bmaj_log_max;
			float obj_quality_da_bmaj_log_min;
			float obj_quality_da_bmin_log_max;
			float obj_quality_da_bmin_log_min;
			float scorer_aux_flux_log_max;
			float scorer_aux_flux_log_min;
			int scorer_aux_mode;
			float scorer_aux_center_scale;
			float scorer_aux_flux_scale;
			float scorer_aux_size_scale;
			float scorer_aux_da_weight;
			float scorer_aux_pixel_arcsec;
			float scorer_aux_beam_arcsec;
			int flux_refine_mode;
			int flux_refine_delta_param_index;
			int flux_refine_gate_param_index;
			int flux_refine_detach_base;
			float flux_refine_loss_scale;
			float flux_refine_gate_loss_scale;
			float flux_refine_final_loss_scale;
			float flux_refine_delta_norm_scale;
			float flux_refine_gate_margin_norm;
			float obb_loss_scale;
		float multi_pos_iou_ratio;
		float multi_pos_min_iou;
		float multi_pos_obj_weight;
		float angle_scale;
	float angle_unit_norm_scale;
	float angle_sm[3];
	float min_angle_IoU_lim;
