...
def training_selection_path():
	if(os.path.isfile("TrainingSet_perscut.txt")):
		return "TrainingSet_perscut.txt"
	return data_path+"TrainingSet_perscut.txt"
...
def init_data_gen():
	...
	train_list = np.loadtxt(training_selection_path())
